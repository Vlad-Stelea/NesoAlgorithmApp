...
public class MachineConfiguration {
    ...
    public MachineConfiguration(String machineConfigName, int l1Cache, int l2Cache, String chip, int threads) {
    ...
    public boolean equals(Object o) {
        ...
        return machineConfigName.equals(mc.machineConfigName);
    }
