...
function addUserListItem(item){
    let output = '<li class="listItem" style="background-color: goldenrod">'+
        ...
        '<h3 style="margin-left: 20px;" class="button">' + item.username + '</h3>' +
        '<button style=" background-color: lightblue; margin-left: 10px;" class="button" onclick="navigation.goToAdminUserActivityPage(\'' + item.username + '\')">View Activity</button>' +
